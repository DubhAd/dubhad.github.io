var store = [{
        ...
        "tags": ["home assistant"],
        "url": "/home-assistant-moving-logs-and-database/",
        "teaser": null
      },{
        ...
        "tags": ["platform"],
        "url": "/choosing-platform/",
        "teaser": null
      },{
        "title": "Backing up Hass.io",
        "excerpt":"I've already talked in general about [backing up Home Assistant](/backup-up-home-assistant/), but for Hass.io the process is slightly different. The problem is that there's no easy access to local USB drives, and the stock SSH add-on doesn't have rsync. The solution comes in the form of an [upgraded SSH add-on](https://github.com/hassio-addons/repository) from...","categories": [],
        "tags": ["backup","hass.io"],
        "url": "/backing-up-hassio/",
        "teaser": null
      },{
        ...
        "tags": ["ssl","home assistant"],
        "url": "/letsencrypt-with-home-assistant/",
        "teaser": null
      },{
        ...
        "tags": ["hass.io","platform","home assistant"],
        "url": "/which-home-assistant-install-is-right/",
        "teaser": null
      },{
        "title": "Upgrading the Python Virtual Environment",
        "excerpt":"Unless you're running local other software directly from the venv, consider [switching to Docker]({{ site.baseurl }}{% post_url 2020-10-10-ha-venv-to-docker %}). It'll save you from ever needing to upgrade Python and rebuild the venv again. **Updates** * **December 2022** Python 3.9 deprecation * **October 2020** for Python 3.7 deprecation, and to add...","categories": [],
        "tags": ["venv","python","home assistant"],
        "url": "/upgrading-python-virtual-environment/",
        "teaser": null
      },{
        ...
        "tags": ["venv","python","home assistant"],
        "url": "/installing-home-assistant-in-virtual/",
        "teaser": null
      },{
        "title": "NGINX and Home Assistant",
        "excerpt":"I'm going to assume that you've already got [Let's Encrypt](https://www.blogger.com/2017/11/letsencrypt-with-home-assistant.html) or your chosen SSL provider configured, and that you've forwarded the port your using. But now you've decided you want finer grained control of access than Home Assistant can provide, or maybe you want to make some use of NGINX's...","categories": [],
        "tags": ["remote access","home assistant","nginx"],
        "url": "/nginx-and-home-assistant/",
        "teaser": null
      },{
        "title": "RFC1918",
        ...
        "url": "/remote-access-for-home-assistant-and/",
        "teaser": null
      },{
        "title": "Why Home Assistant?",
        "excerpt":"I said [a while back](/choosing-platform/) that I use [Home Assistant](https://home-assistant.io/), but I didn't really say why. ## Exploring the market I spent a few months looking at a number of open source platforms, and I only found one other actively developed comparable platform ([OpenHAB](https://www.openhab.org/)). The others were either abandoned, atrophying,...","categories": [],
        "tags": ["platform","home assistant","openhab"],
        "url": "/why-home-assistant/",
        "teaser": null
      },{
        "title": "Remote access via PiVPN",
        "excerpt":"I've already talked about [setting up remote access](/remote-access-for-home-assistant-and/), and [configuring SSL certificates](/letsencrypt-with-home-assistant/) for Home Assistant. What though if you're not using cloud services, and just want to be able to interact with Home Assistant (or anything else on your network) while you're away. Or maybe just avoid having the owner of...","categories": [],
        "tags": ["remote access","openvpn","pivpn","home assistant","vpn"],
        "url": "/remote-access-via-pivpn/",
        "teaser": null
      },{
        ...
        "url": "/how-not-to-break-manual-control-of/",
        "teaser": null
      },{
        "title": "The secret is (not) to bang the rocks together",
        "excerpt":"[^1] _So many people seem to [purchase a stack of kit](/putting-cart-before-horse/), and want it to magically work together, or see the low cost of entry by using an open source project, [and assume](/choosing-platform/) they don't have to learn._ _If there's one thing I've learned when, well, tackling anything new, it's...","categories": [],
        "tags": ["help","vampire","learning","home assistant"],
        "url": "/the-secret-is-not-to-bang-rocks-together/",
        "teaser": null
      },{
        ...
        "url": "/home-assistant-and-basic-presence/",
        "teaser": null
      },{
        ...
        "url": "/home-assistant-avoiding-insecurity/",
        "teaser": null
      },{
        ...
        "url": "/home-assistant-shopping-bag-is-missing/",
        "teaser": null
      },{
        ...
        "url": "/triggers-and-conditions-and-actions-oh/",
        "teaser": null
      },{
        ...
        "tags": ["dashboards"],
        "url": "/lovelace-next-generation-of-stock-ui/",
        "teaser": null
      },{
        ...
        "tags": ["z-wave"],
        "url": "/sensative-strips-guard-review/",
        "teaser": null
      },{
        ...
        "url": "/turbulence-ahead-fasten-your-seatbelt/",
        "teaser": null
      },{
        ...
        "url": "/a-while-back-i-covered-how-i-was-doing/",
        "teaser": null
      },{
        ...
        "tags": ["cloud","home assistant"],
        "url": "/home-assistant-cloud-goes-paid/",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "/presence-detection-update-3/",
        "teaser": null
      },{
        ...
        "url": "/product-comparison-smart-displays/",
        "teaser": null
      },{
        ...
        "tags": ["home assistant","presence detection"],
        "url": "/presence-detection-are-we-nearly-there/",
        "teaser": null
      },{
        ...
        "url": "/breaking-up-automationsroom-activity/",
        "teaser": null
      },{
        ...
        "url": "/my-great-migration-part-one/",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "/the-great-migration-part-two/",
        "teaser": null
      },{
        ...
        "url": "/presence-detection-final-countdown/",
        "teaser": null
      },{
        ...
        "url": "/presence-detection-one-last-time/",
        "teaser": null
      },{
        ...
        "url": "/cameras-motion-detection-and/",
        "teaser": null
      },{
        ...
        "url": "/moving-from-wink-to-home-assistant/",
        "teaser": null
      },{
        ...
        "url": "/yaml-in-automations-and-scripts/",
        "teaser": null
      },{
        ...
        "url": "/home-assistant-docker-and-using-ssh/",
        "teaser": null
      },{
        ...
        "url": "/presence-detection-resurrection/",
        "teaser": null
      },{
        ...
        "url": "/zigbee2mqtt-native-to-docker-migration/",
        "teaser": null
      },{
        ...
        "tags": ["automation","home assistant"],
        "url": "/why-didnt-my-automation-run/",
        "teaser": null
      },{
        ...
        "tags": ["automation","home assistant"],
        "url": "/running-automation-every-time-sensor/",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "/how-should-i-install-home-assistant/",
        "teaser": null
      },{
        ...
        "tags": ["remote access","home assistant"],
        "url": "/traefik-and-remote-home-assistant/",
        "teaser": null
      },{
